  ...
  return (
    <div className="phone-ui-container">
      <div className="phone-shell crt-flicker" role="presentation">
        {/* Hardware Status Bar */}
        <div aria-hidden="true" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '14px', padding: '0 20px' }}>
        ...
        {/* Hardware Footer */}
        <div aria-hidden="true" style={{ marginTop: '14px', display: 'flex', justifyContent: 'center', gap: '50px', alignItems: 'center' }}>
        ...
        <div aria-hidden="true" style={{ position: 'absolute', right: '-14px', top: '120px', display: 'flex', flexDirection: 'column', gap: '20px' }}>
