...
export const getCardPalette = (card) => {
    var _a;
    const typePalettes = {
    ...
    const palette = ((card === null || card === void 0 ? void 0 : card.creatureType) && typePalettes[card.creatureType]) || typePalettes.default;
    return Object.assign(Object.assign({}, palette), { rarityFinish: rarityFinish[(_a = card === null || card === void 0 ? void 0 : card.rarity) !== null && _a !== void 0 ? _a : 'common'] });
};
